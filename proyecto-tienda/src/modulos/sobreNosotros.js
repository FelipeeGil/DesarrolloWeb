export const SobreNosotros = () => {
    return (
      <div>
        ...
        <img src="https://www.recetasnestlecam.com/sites/default/files/styles/crop_article_banner_desktop_nes/public/2021-12/lista-de-supermercado.webp?itok=5nNOzQl8" alt="foto"></img>
        <p>
          ...
          Agradecemos su confianza en Mercatodo y esperamos que tenga una experiencia de compra placentera y satisfactoria con nosotros. ¡Gracias por visitar nuestro sitio web y por elegir Mercatodo como su supermercado en línea de confianza!</p>
        ...
        <p>
          ...
          También estamos comprometidos con la sostenibilidad y el impacto positivo en el medio ambiente. En el futuro, seguiremos buscando formas de reducir nuestro impacto ambiental y promover prácticas más sostenibles en toda nuestra cadena de suministro.</p>
